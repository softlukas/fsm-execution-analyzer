...
#include <memory>
#include "../../../src/gui_app/GraphicsView.h"
...
QT_MOC_LITERAL(1, 13, 16), // "stateItemClicked"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 19), // "QGraphicsItemGroup*"
QT_MOC_LITERAL(4, 51, 5), // "item1"
QT_MOC_LITERAL(5, 57, 18), // "QGraphicsLineItem*"
QT_MOC_LITERAL(6, 76, 5) // "item2"

    },
    "GraphicsView\0stateItemClicked\0\0"
    "QGraphicsItemGroup*\0item1\0QGraphicsLineItem*\0"
    "item2"
};
...
void GraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->stateItemClicked((*reinterpret_cast< QGraphicsItemGroup*(*)>(_a[1])),(*reinterpret_cast< QGraphicsLineItem*(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GraphicsView::*)(QGraphicsItemGroup * , QGraphicsLineItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsView::stateItemClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GraphicsView::stateItemClicked(QGraphicsItemGroup * _t1, QGraphicsLineItem * _t2)
{
